    ...
    >
      ...
      >
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Text color={"gray.500"}>
            Improve user experience, boost your SEO rankings, and engage
            visitors with faster loading times. Optimize your images today and
            watch your website soar!
          </Text>
          <Stack
            spacing={{ base: 4, sm: 6 }}
        ...
        >
          <Blob
            ...
            left={0}
            zIndex={-1}
            color={useColorModeValue("#e5e2ef", "red.400")}
          />
          <Box
            position={"relative"}
            height={"300px"}
